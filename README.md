...
Candidate totals are distributed across cash, TFSA, RRSP/RRIF, and non-registered accounts using their exact projected retirement-boundary weights. Account type, return, withdrawal priority, allocation, and identity are preserved, with any residual cent assigned deterministically. In simplified non-registered mode, each candidate taxable account also preserves its projected retirement-boundary ACB-to-market-value ratio; a positive candidate cannot invent ACB from a zero projected market value. Residence value, other non-financial assets, home equity, and liabilities are excluded from the funding composition. If the projected financial accounts cannot provide a valid positive composition, the requirement is shown as unavailable instead of inventing weights.

The requirement uses the active tax, RRIF, and non-registered modes. It is complete for the supported deterministic tax model only when annual Canadian tax, statutory RRIF minimums, and simplified Canadian non-registered taxation are all explicitly active. Compatibility combinations remain provisional. Supported-model completion does not claim full tax-return fidelity.
...
For a mid-year projection start, opening context is required through the preceding month. Simplified non-registered mode requires explicit opening interest, actual eligible dividends, foreign income, capital gains, and capital losses, including explicit zeros. Opening context affects brackets, credits, and OAS recovery but is neither deposited nor taxed again inside the projection. Each modelled month recognizes the cumulative annual federal/Ontario liability beyond tax already embedded in opening and net-employment income. If later income or a current-year capital loss reprices that cumulative amount downward, the ledger records the signed adjustment while cumulative projection-funded tax remains non-negative. OAS recovery uses supported annual taxable income rather than a monthly proxy. Taxable RRSP/RRIF and non-registered cash needs use bounded integer-cent searches for the lowest gross withdrawal whose signed incremental-tax-adjusted proceeds pass; cash and TFSA withdrawals remain tax free.

Eligible Canadian dividends retain their actual amount, use a 138% taxable amount, and receive non-refundable federal and Ontario eligible-dividend credits of 15.0198% and 10% of the taxable dividend respectively. Interest and supported foreign or other ordinary investment income are fully taxable; foreign dividends receive no Canadian dividend credit. Current net capital gains use a fixed 50% inclusion rate. Budget 2025 confirmed that the proposed two-thirds inclusion rate and $250,000 individual threshold would not proceed, so neither is implemented. Fixed dividend and capital-gain percentages remain unchanged in deterministic forecast years.

### Simplified non-registered taxation

Existing configurations omit `nonRegisteredTaxation` and visibly normalize to `not_modelled_compatibility`, preserving every previous total-return and withdrawal result without requiring ACB evidence. To opt in, use `tax.mode: canadian_annual` and configure exactly one treatment for every included `non_registered` account:
  ...
  accounts:
    - accountId: projection:future-taxable
      annualDistributionYields:
        interest: 0.005
        eligibleCanadianDividends: 0.01
        foreignIncome: 0.01
        capitalGains: 0
```

A positive opening balance additionally requires an explicit, same-date `openingAdjustedCostBase` amount and source description; the planner never assumes market value is ACB. A zero-balance projection-created account may resolve to zero ACB. ACB may exceed market value, while positive market value with explicit zero ACB is accepted with a warning.

The account's existing `annualReturn` remains its total pre-tax return. Monthly interest, eligible-dividend, foreign-income, and capital-gain distributions characterize that return using the same annual-to-monthly convention. They are automatically reinvested: market value changes only by the original total return, while actual distributions increase pooled account ACB. The residual is unrealized change, which may be negative and does not change ACB. Dividend gross-up, tax credits, and taxable capital-gain inclusion do not change ACB.

External contributions and routed surplus, including RRIF-forced surplus, increase both market value and ACB without immediate taxable income. A withdrawal is a proportional disposition of one pooled synthetic portfolio: proceeds consume the same fraction of current raw ACB and create a realized gain or loss. The exact-cent solver previews that gain or loss in the shared annual tax engine, supports signed tax repricing, and commits the accepted sale once. Current-year losses offset gains only; unused losses remain visible but are not carried backward or forward.

The supported model does not track securities, tax lots, cross-account identical property, superficial losses, return of capital, commissions, foreign tax credits, non-eligible dividends, arbitrary deductions, refundable credits, alternative minimum tax, or optimized withdrawals. These define the supported planning boundary without making the fully explicit three-mode combination provisional. Full tax-return fidelity remains false.

The annual tax result is a deterministic planning estimate rather than full tax-return preparation. Partial years use full annual credit amounts and are labelled partial estimates. Official reference provenance is included in the shared result and exports.

Statutory calculations retain raw nominal precision and round the aggregate annual liability once; any presentation-cent residual is assigned deterministically to Ontario net tax so the displayed components still reconcile. The 2026 OAS recovery threshold is identified as an official published estimate rather than a final amount. Primary references for ordinary tax include [CRA 2026 federal/Ontario payroll tables](https://www.canada.ca/en/revenue-agency/services/forms-publications/payroll/t4032-payroll-deductions-tables/t4032on-jan/t4032on-january-general-information.html), [CRA payroll formulas](https://www.canada.ca/en/revenue-agency/services/forms-publications/payroll/t4127-payroll-deductions-formulas/t4127-jul/t4127-jul-payroll-deductions-formulas.html), [federal TD1 credits](https://www.canada.ca/en/revenue-agency/services/forms-publications/td1-personal-tax-credits-returns/td1-forms-pay-received-on-january-1-later/td1.html), [Ontario TD1 credits](https://www.canada.ca/en/revenue-agency/services/forms-publications/td1-personal-tax-credits-returns/td1-forms-pay-received-on-january-1-later/td1on.html), and [OAS recovery tax](https://www.canada.ca/en/services/benefits/publicpensions/old-age-security/recovery-tax.html). Investment-tax references include [CRA interest and other investment income](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/personal-income/line-12100-interest-other-investment-income.html), [CRA eligible dividends](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/personal-income/line-12000-taxable-amount-dividends-eligible-other-than-eligible-taxable-canadian-corporations.html), [federal dividend tax credit](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/deductions-credits-expenses/line-40425-federal-dividend-tax-credit.html), [Ontario dividend tax credit](https://www.ontario.ca/page/ontario-dividend-tax-credit), [CRA capital gains and losses](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/personal-income/line-12700-capital-gains/calculating-reporting-your-capital-gains-losses.html), [CRA adjusted cost base](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/personal-income/line-12700-capital-gains/calculating-reporting-your-capital-gains-losses/adjusted-cost-base.html), and [Finance Canada 2026 tax expenditures](https://www.canada.ca/en/department-finance/services/publications/federal-tax-expenditures/2026/part-6.html).
...
Baseline schema `5.0` includes aggregate cash-flow and debt-payment audit evidence, typed imported non-financial-asset balances, distinct financial accounts, non-financial assets and liabilities, simple/advanced mode, the resolved terminal-balance criterion and compatibility source, resolved tax, RRIF, and non-registered modes, opening tax-year context, ACB assumptions and provenance, resolved employment, savings, and lifestyle-spending phases, concrete CPP/OAS inputs, registered room, routing, and field-level provenance. It contains category/account names and reconciled aggregates—not raw transactions, transaction IDs, raw liability matcher text, credentials, tokens, or private statement metadata.
...
`GET /api/v1/baseline/current` returns schema `5.0` projection inputs, simple/advanced mode, terminal-balance and tax provenance, role/compiler, phase, benefit, financial-account, imported non-financial-asset, liability, savings-policy, registered-room, non-registered tax/ACB, and waterfall provenance; derived values; cash-flow and debt-payment audit evidence; warnings; and mapping details.
...
Schema `13.0` JSON is the complete analysis document and uses a typed allowlist with export-local aliases; it never recursively copies source objects. JSON retains typed non-financial assets, liabilities and schedules, debt-payment evidence, lifestyle-spending phases, balance sheets, financial-assets and net-worth bridges, the retirement requirement and anonymized account composition, annual tax evidence, non-registered ACB and distribution evidence, room ledgers, routes, and policy results with sanitized references. ACB source descriptions are replaced with generic share-safe text. The flat CSV keeps one row per annual period with stable scalar coverage, investment-income, ACB, requirement, tax, composition, balance-sheet, liability-flow, explicit-plan, unplanned-cash, room, contribution, and deterministic per-account fields. It never embeds schedules, role lists, route arrays, phase arrays, maps, JSON, or delimited lists in cells. Nominal and real modes remain rectangular and both formats remain automatically anonymized.
