...
The exact retirement snapshot is captured at the end of the final working month, immediately before the first fully retired month. Retirement funding assets use this real-dollar snapshot rather than the next December row. The projection also emits nominal and real financial-assets and net-worth bridges. Liability cash payments reduce financial assets; principal reduces the liability by the same amount and is not consumption; interest reduces net worth. Both bridges and every liability schedule must reconcile within one cent.
