...
function surplusAllocationDocument(
  ...
  return {
    ...
    steps: [
      ...
      {
        label: "Policy deposits by account",
    ...
    caveats: [
      ...
      `Generated surplus and retained plus redirected differ by ${exactCurrency.format(totals.generated - routedTotal)}; account deposits differ from generated by ${exactCurrency.format(accountAllocationTotal - totals.generated)}.`,
    ],
    reconciliation: matched(routedTotal, totals.generated),
  };
}
